...
const FAQ = () => {
  return (
    <FAQStyleWrapper className="rsc_faq_sect" id="faq">
      <div className="container">
        <div className="rsc_faq_content">
          <SectionTitle
            isCenter={true}
          ...
          <div className="rsc_faq_questions">
            <div className="faq_bear_img">
              <img src={faqBearShape} alt="rsc nft faq" />
            </div>
            ...
            <div className="faq_bg_wattermark">
              <img src={faqBgThumb} alt="rsc nft faq" />
            </div>
          </div>
        </div>
      </div>
