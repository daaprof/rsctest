...
const Banner = () => {
  ...
  return (
    <BannerStyleWrapper className="rsc_v2_baner_sect" id="home">
      <div className="container">
        <div className="rsc_v2_baner_content">
          <h2>
            {" "}
          ...
          <div className="rsc_v2_timer">
            <h4>TIME LEFT</h4>
            <div className="timer timer_1">
              <CountdownTimer {...settings} />
            </div>
          </div>
          <div className="rsc_v2_baner_buttons text-center">
