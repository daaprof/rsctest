...
const Footer = () => {
  return (
    <FooterStyleWrapper>
      ...
      <div className="rsc_v1_main_footer">
        <div className="rsc_v1_main_footer_overlay"></div>
        <div className="three_charectre_img">
          <img src={characterShape} alt="rsc nft character" />
        </div>

        <div className="footer_bottom">
          <div className="footer_bottom_content">
            <span className="footer_shapes_left">
              <img src={footerShapesLeft} alt="rsc nft footer" />
            </span>
            <span className="footer_shapes_right">
              <img src={footerShapesRight} alt="rsc nft footer" />
            </span>
              ...
              <div className="footer_menu">
                <div className="bottom_footer_left">
                  <div className="footer_logo">
                    <a href="# ">
                      <img src={footerLogo} alt="rsc nft logo" />
                    </a>
                  </div>
                  <div className="copiright_text">
                    <p>Copyright © 2022 RSC</p>
                  </div>
                </div>
                <a href="# " className="bact_to_top_btn">
                  <img src={backToTopIcon} alt="rsc nft back to top" />
                </a>
